...
@Composable
fun PrinterRendererScreen(viewModel: PrinterViewModel) {
    ...
    Column(
        ...
        IndustrialPanel(title = "Execution Progress") {
            ...
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                Text("Layer: 142 / 200", color = IndustrialColors.TextSecondary)
                Text("Time: 01:45:00", color = IndustrialColors.TextSecondary)
            }
        }
